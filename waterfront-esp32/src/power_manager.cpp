...
RTC_DATA_ATTR static unsigned long totalAwakeTime;
RTC_DATA_ATTR static unsigned int wakeUpCount;
RTC_DATA_ATTR static int lastWakeUpCause;
RTC_DATA_ATTR static unsigned long awakeStartTime;
